...
class DueDDQNAgent:
    def __init__(self, action_size):
        ...
        #self.summary_writer = tf.summary.FileWriter('summary/breakout_dueling_ddqn/breakout_dueling_ddqn_padrao_2k', self.sess.graph)
        self.sess.run(tf.global_variables_initializer())

        if self.load_model: self.model.load_weights("./trained/"+NAME+"/saved_model/"+NAME+".h5")
        #if self.load_model: self.model.load_weights("./saved_model/breakout_dueling_ddqn/breakout_dueling_ddqn_padrao_2k.h5")
    ...
    #with open (b"./data_csv/breakout_dueling_ddqn/breakout_dueling_ddqn_padrao_2k.csv","w") as csv_file:
        ...
        for e in range(EPISODES):
            ...
            if e % 1000 == 0:
                ...
                #agent.model.save_weights("./saved_model/breakout_dueling_ddqn/breakout_dueling_ddqn_padrao_2k.h5")
                #print("MODEL SAVED in: /saved_model/breakout_dueling_ddqn/breakout_dueling_ddqn_padrao_2k.h5")
