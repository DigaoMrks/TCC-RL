...
class DQNAgent:
    def __init__(self, action_size):
        ...
        self.action_size = action_size # Número de ações possíveis no jogo, + 'do nothing' (Spaceinvaders = <, >, 'do nothing', 'do nothing'+shoot, >+shoot, <+shoot = 6)
        ...
        self.summary_writer = tf.summary.FileWriter('summary/spaceinvaders_dqn/spaceinvaders_dqn_padrao_1k', self.sess.graph)
        self.sess.run(tf.global_variables_initializer())

        if self.load_model: self.model.load_weights("./saved_model/spaceinvaders_dqn/spaceinvaders_dqn_padrao_1k.h5")
...
if __name__ == "__main__":
    ...
    with open (b"./data_csv/spaceinvaders_dqn/spaceinvaders_dqn_padrao_1k.csv","w") as csv_file:
        ...
        for e in range(EPISODES):
            ...
            while not done:
                ...
                # Se o agente levar um tiro, ele "morre" --> MAS o episódio não terminou
                ...
                if done:
                    ...
                    print("episode:", e, "  score:", score, "  memory length:",
                          ...
                          agent.avg_loss / float(step), "e%", (e % 100),"Frames:",frames)
            ...
            if e % 1000 == 0:
                agent.model.save_weights("./saved_model/spaceinvaders_dqn/spaceinvaders_dqn_padrao_1k.h5")
                print("MODEL SAVED in: /saved_model/spaceinvaders_dqn/spaceinvaders_dqn_padrao_1k")
