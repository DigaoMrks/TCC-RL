...
if __name__ == "__main__":
    ...
    #with open (b"./data_csv/spaceinvaders_dqn/spaceinvaders_dqn_padrao_2k.csv","w") as csv_file:
		...
		#agent.model.save_weights("./saved_model/spaceinvaders_dqn/spaceinvaders_dqn_padrao_2k.h5")
                #print("MODEL SAVED in: /saved_model/spaceinvaders_dqn/spaceinvaders_dqn_padrao_2k")
