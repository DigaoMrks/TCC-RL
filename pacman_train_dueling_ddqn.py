...
class DueDDQNAgent:
    def __init__(self, action_size):
        ...
        self.summary_writer = tf.summary.FileWriter('summary/pacman_dueling_ddqn/pacman_dueling_ddqn_padrao_1k', self.sess.graph)
        self.sess.run(tf.global_variables_initializer())

        if self.load_model: self.model.load_weights("./saved_model/pacman_dueling_ddqn/pacman_dueling_ddqn_padrao_1k.h5")
...
if __name__ == "__main__":
    ...
    with open (b"./data_csv/pacman_dueling_ddqn/pacman_dueling_ddqn_padrao_1k.csv","w") as csv_file:
        ...
        for e in range(EPISODES):
            ...
            if e % 1000 == 0:
                agent.model.save_weights("./saved_model/pacman_dueling_ddqn/pacman_dueling_ddqn_padrao_1k.h5")
                print("MODEL SAVED in: /saved_model/pacman_dueling_ddqn/pacman_dueling_ddqn_padrao_1k.h5")
