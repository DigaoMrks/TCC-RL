...
class DueDDQNAgent:
    def __init__(self, action_size):
        ...
        self.summary_writer = tf.summary.FileWriter('summary/spaceinvaders_dueling_ddqn/spaceinvaders_dueling_ddqn_padrao_1k', self.sess.graph)
        self.sess.run(tf.global_variables_initializer())

        if self.load_model: self.model.load_weights("./saved_model/spaceinvaders_dueling_ddqn/spaceinvaders_dueling_ddqn_padrao_1k.h5")
...
if __name__ == "__main__":
    ...
    with open (b"./data_csv/spaceinvaders_dueling_ddqn/spaceinvaders_dueling_ddqn_padrao_1k.csv","w") as csv_file:
